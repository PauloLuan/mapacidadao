...
DATABASES = {
    'default': {
        ...
        'NAME': 'mapacidadao',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '&amp;ncknaa8_z7g3_tf)!gdt_p456@m&amp;95^!kt^8^--c0(eom_ces'
...
ROOT_URLCONF = 'mapacid.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'mapacid.wsgi.application'
